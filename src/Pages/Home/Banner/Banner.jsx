    ...
    >
      ...
      <div className="relative z-10 h-full">
        <div>
          ...
          <button className="btn md:btn-md btn-md text-xs font-bold bg-[#FEBF00] hover:bg-[#FEBF00] uppercase rounded-none border-none ml-4 px-6 py-2 absolute xl:bottom-64 lg:bottom-48 md:bottom-36 bottom-[420px] xl:left-40 lg:left-14 md:left-8 ">
            Explore Menu
          </button>
        </div>
        <div className="">
          <img
            className="absolute xl:right-40 lg:right-14 md:right-9 right-0 md:px-0 px-2 md:bottom-28 bottom-5 xl:w-2/5 lg:w-1/2 md:w-1/2 w-full xl:h-[500px] lg:h-[450px] md:h-[350px] h-[370px]"
            src={bannerImage}
            alt="banner"
          />
        </div>
      </div>
      <div className="absolute xl:top-[150px] lg:top-24 md:top-24 top-[360px] xl:right-28 lg:right-4 md:right-5 right-3">
        <img className="" src={flowerImg} alt="flower decoration" />
      </div>
